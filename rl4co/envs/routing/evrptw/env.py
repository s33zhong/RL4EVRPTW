...
class EVRPTWEnv(CVRPEnv):
    ...
    #     # For exceeds_fur station, it doesn't consider the dist_to_depot as after visitinig station,
    #     # its fuel will be fully charged.
    #     exceeds_fuel_for_station = td["current_fuel"] - dist_to_loc < 0
    #     mask_station = ((td["current_node"] >= station_index & unserved_reachable)
    #                     | exceeds_fuel_for_station[..., station_index:]
    ...
    #     # print("mask_station: ", mask_station)
